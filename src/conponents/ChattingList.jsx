                        ...
                        <ChattingRoomList>
                            {chattingRooms.filter((chattingRoom) => chattingRoom.chattingRoom.message).length ? (
                                chattingRooms.map((chattingRoom) =>
                                    chattingRoom.chattingRoom.message ? (
                                        <ChattingRoom key={chattingRoom.chattingRoom.id}>
                                            <button
                                                type="button"
                                                onClick={() => navigator(`${chattingRoom.chattingRoom.id}`)}
                                            >
                                                <img src={chattingRoom.chattingRoom.trainerImage} />
                                                <ChattingRoomMessage>
                                                    <ChattingOpponentInformation>
                                                        <OpponentName>
                                                            <h2>{chattingRoom.chattingRoom.trainerName}</h2>
                                                            <p>트레이너</p>
                                                        </OpponentName>
                                                    ...
                                                    <ChattingRoomTime>
                                                        <h2>
                                                            {dateFormatter.localTime(
                                                                chattingRoom.chattingRoom.updateTime
                                                            )}
                                                        </h2>
                                                        {chattingRoom.count ? <p>{chattingRoom.count}</p> : null}
                                                    </ChattingRoomTime>
                                                </ChattingRoomMessage>
                                            </button>
                                        </ChattingRoom>
